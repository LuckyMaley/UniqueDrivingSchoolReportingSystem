...
Public Class DrillCrystalReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1CrystalReports.DrillCrystalReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDrillCrystalReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DrillCrystalReport = New DrillCrystalReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
