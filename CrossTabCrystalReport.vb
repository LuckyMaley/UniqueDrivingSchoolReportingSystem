...
Public Class CrossTabCrystalReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1CrystalReports.CrossTabCrystalReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrossTabCrystalReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrossTabCrystalReport = New CrossTabCrystalReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
